    ...
    if (
        ...
        <div class="notice error wppp-settings-get-credentials-admin-notice">
            <p>
                ...
                If you haven't created Pixpie account before - fill the form below and start using the plugin in 2
                clicks.<br/>
...
/*                    $all_sizes = wppp_get_image_sizes();
                    ...
                    */?>
                    ...
                    <?php
                    echo get_option(WPPP_OPTION_NAME_KEEP_ORIGINAL) ?>
                    ...
                    <ul class="imageSizesPiexpie">
                        ...
                        foreach ($all_sizes as $size_name => $size_val) {
                            ...
                            ?>
                            <li><label><input type="checkbox" name="<?php echo $size_name ?>"> <?php echo $size_name ?>
                                </label></li>
                            <?php
                        }
                        ?>
